...
const MentorCardItem1 = ({ item }) => {
  ...
  const truncatedText = description.slice(0, 250); // Show only the first 100 characters
    ...
    >
      <Box id="testimonials" className="testimonials" sx={{py:2}}>
        <div className="testimonial-item">
          <p style={{backgroundColor: 'rgb(217, 219, 225)'}}>
...
export default MentorCardItem1;
