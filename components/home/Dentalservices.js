...
const containerVariants = {
  ...
  style={{
    position: "relative",
    background: "linear-gradient(to right, rgba(61, 7, 5, 0.9), rgba(80, 32, 6, 0.88))",
    overflow: "hidden",
  ...
  >
              <Card
                sx={{
                  ...
                  height: '100%', // Important: card takes full height of grid item
                  '&:hover': {
                    transform: 'scale(1.05)',
                    boxShadow: '0 10px 20px rgba(0,0,0,0.2)',
                    borderBottom: '4px solid #fcb950',
                  },
                }}
              >
    <motion.div
